    ...
    private void initView() {
        ...
        getWindow().getDecorView().post(new Runnable() {
            ...
            public void run() {
                ...
                mRecyclerView.addItemDecoration(new GridSpacingItemDecoration(4, 10, false, mFinishTv.getMeasuredHeight(), mFinishTv.getMeasuredHeight() + 10));
        ...
        public int onItemClick(ISelectImageItem item, int pos) {
            if (item.isChecked()) {
                ...
                if (mMaxImgCount > 0 && mSelectSortPosList.size() >= mMaxImgCount) {
                    Toast.makeText(ImageSelectorActivity.this, "每次最多选择"+mMaxImgCount+"张照片！", Toast.LENGTH_LONG).show();
                    return -1;
                }
