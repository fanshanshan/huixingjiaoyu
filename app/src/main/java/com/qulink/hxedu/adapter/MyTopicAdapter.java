...
public class MyTopicAdapter extends RecyclerView.Adapter {
    ...
    public MyTopicAdapter(List<PicBean> list, Context context) {
        this.data = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        PicBean shareContentBean = data.get(position);
        ViewHolder holder = (ViewHolder)viewHolder;
        App.getInstance().getUserInfo(context, new UserInfoCallback() {
            @Override
            public void getUserInfo(UserInfo userInfo) {
                ...
                App.getInstance().getDefaultSetting(context, new DefaultSettingCallback() {
                    ...
                    public void getDefaultSetting(DefaultSetting defaultSetting) {
                        Glide.with(context).load(ImageUtils.splitImgUrl(defaultSetting.getImg_assets_url().getValue(), userInfo.getHeadImg())).into(holder.ivHeadimg);
                    }
                });
                if (CourseUtil.isOk(userInfo.getStatus())) {
