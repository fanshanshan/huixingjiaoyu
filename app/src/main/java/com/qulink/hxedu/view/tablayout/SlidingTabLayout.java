package com.qulink.hxedu.view.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelectTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_select_textsize, sp2px(14));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX,isSelected()?mSelectTextsize:mTextsize );
...
//                if (i == 0) {
//                    tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextsize + selectTxtSizeIncrease);
//                }
            }
        }
    }
